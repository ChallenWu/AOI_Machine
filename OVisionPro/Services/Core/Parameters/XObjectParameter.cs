...
namespace OVisionPro
{
    class XObjectCVParameters
    {
        ...
        [Category("Tool Paraameters")]
        [DisplayName("Run Parameters")]
        [Description("Store parameters of this tool.")]
        public NestedDictionaryWrapper Parameters { get; set; }
    ...
    class NestedDictionaryWrapper : INotifyPropertyChanged
    {
