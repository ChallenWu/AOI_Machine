...
namespace XCore
{
    public class XSetting : XObject
    {
        ...
        public void SetNodeValue(string nodeName, string[] setValue)
        {
            try
            {
                settingMap[nodeName] = XConvert.StrG2Str(setValue, ",");
                SaveSetting();
            }
            catch (KeyNotFoundException knfe)
            {
                settingMap.TryAdd(nodeName, XConvert.StrG2Str(setValue, ","));;
            }
        }
        public void SetNodeValue(string nodeName, string setValue)
        {
        ...
        public string[] GetNodeValue(string nodeName, string[] defaultValue)
        {
            try
            {
                return XConvert.Str2StrG(settingMap[nodeName], ',');
            }
            catch (KeyNotFoundException knfe)
            {
                settingMap.TryAdd(nodeName, XConvert.StrG2Str(defaultValue, ","));
                SaveSetting();
                return defaultValue;
            }
        }
