...
namespace XCore
{
    public class XCommandCard208C : XCommandCard
    {
        ...
        {
            return APS168.APS_absolute_move(axisId, (int)position, (int)vel);
        }

        public override int MoveRel(int actCardId, int axisId, double distance, double vel)
        {
            return APS168.APS_relative_move(axisId,(int) distance, (int)vel);
        }
        ...
        {
            int ret = 0;
            ret = APS168.APS_set_axis_param_f(axisId, (int)APS_Define.PRA_ACC, acc);
            if (ret != 0)
                return ret;
        ...
        {
            return APS168.APS_set_axis_param_f(axisId, (int)APS_Define.PRA_STP_DEC, XConvert.MM2PULS(dec, lead));
        }
