...
namespace XCore
{
    public class XStation : XStationEventHandler
    {
        ...
        public void SetLightBirdDo(int setDoId)
        {
            if (setDoId < 0)
            {
                birdLight = null;
            ...
            birdLight = XDevice.Instance.FindDoById(setDoId);
        }
        ...
        private void OnlyRedLightOn()
        {
            if (redLight != null)
            {
                redLight.SetDo(DOSTSTYPE.HIGH);
            }
            if (birdLight != null)
            {
                birdLight.SetDo(DOSTSTYPE.HIGH);
            }
            if (orangeLight != null)
            {
                orangeLight.SetDo(DOSTSTYPE.LOW);
            }
            if (greenLight != null)
            {
                greenLight.SetDo(DOSTSTYPE.LOW);
            }
        }
        ...
        private void OnlyOrangeLightOn()
        {
            if (redLight != null)
            {
                redLight.SetDo(DOSTSTYPE.LOW);
            }
            if (birdLight != null)
            {
                birdLight.SetDo(DOSTSTYPE.LOW);
            }
            if (orangeLight != null)
            {
                orangeLight.SetDo(DOSTSTYPE.HIGH);
            }
            if (greenLight != null)
            {
                greenLight.SetDo(DOSTSTYPE.LOW);
        ...
        private void OnlyGreenLightOn()
        {
            ...
            if (greenLight != null)
            {
                greenLight.SetDo(DOSTSTYPE.HIGH);
            }
        }
