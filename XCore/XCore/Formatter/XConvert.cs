...
namespace XCore
{
    public class XConvert : XObject
    {
        ...
        //{
        //    return Convert.ToInt32(MM * 1 / lead);
        //}
        public static double MM2PULS(double MM, double lead)
        {
            return (double)(MM * 1 / lead);
        }
        public static double PULS2MM(double PULS, double lead)
        {
            return PULS * lead ;
        }
        #endregion
